...
export function DotMatrixBackground({ className = "", ...props }: DotMatrixBackgroundProps) {
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms,
      vertexShader: CORE_UPLINK_VERTEX_SHADER,
      fragmentShader: CORE_UPLINK_FRAGMENT_SHADER,
      transparent: true,
      depthWrite: false,
    });
  ...
  return (
    <div ref={hostRef} className={`threeui-background dot-matrix${className ? ` ${className}` : ""}`}>
